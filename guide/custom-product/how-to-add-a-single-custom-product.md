...
![Custom Products from AzonPress Dashboard](/guide/public/images/custom-product/how-to-add-a-single-custom-product/custom-prducts-from-azonpress-dashboard.webp)

Now, select the **Single Product Template** option, enter the **Link** of the **Amazon product** that you want to add under the **URL** field, and press the **Continue** button. Your single custom product will be added!

![Adding Single Custom Product](/guide/public/images/custom-product/how-to-add-a-single-custom-product/adding-single-custom-product.webp)
...
Now, click the **Edit** button and a popup page will appear where you will get all the options to edit your product.

![Edit option of single custom product](/guide/public/images/custom-product/how-to-add-a-single-custom-product/edit-option-of-single-custom-product.webp)
...
![Edit Product Popup page](/guide/public/images/custom-product/how-to-add-a-single-custom-product/edit-product-popup-page.webp)

Here, you can see the Preview of the **Edited** custom product.

![Preview of Edited single custom product](/guide/public/images/custom-product/how-to-add-a-single-custom-product/preview-of-edited-single-custom-product.webp)
