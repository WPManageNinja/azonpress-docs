...
![Add Classic editor block in a post](/guide/public/images/available-products-templates/widget-template/add-classic-editor-block-in-a-post.webp)

Next, click the **Add Media** option from the **classic editor** bar, and a pop-up window appears with a couple of options.

![Add media option from the classic editor](/guide/public/images/available-products-templates/widget-template/add-media-option-from-the-classic-editor.webp)
...
Here, is the preview of the post where the selected Amazon Products are displayed as a Widget template.
...
**Reference:** [Widget Template](https://wpmanageninja.com/docs/azonpress/placing-products-shortcodes/featured-widget/)
