...
To learn the use of the Box Template, follow the steps with the screenshots below –
...
![Add Classic editor block in a post](/guide/public/images/available-products-templates/box-template/add-classic-editor-block-in-a-post.webp)

Next, click the **Add Media** option from the **classic editor** bar, and a pop-up window appears with a couple of options.

![Add media option from the classic editor](/guide/public/images/available-products-templates/box-template/add-media-option-from-the-classic-editor.webp)
...
* Here, you will get the Box template under the **Select Layout** option, **enable** the **checkbox** to use this.
...
![Box template checkbox](/guide/public/images/available-products-templates/box-template/box-template-checkbox.webp)

Here, is the preview of the post where the selected Amazon Products are displayed as a Box template.

![Preview of Box template](/guide/public/images/available-products-templates/box-template/preview-of-box-template.webp)
